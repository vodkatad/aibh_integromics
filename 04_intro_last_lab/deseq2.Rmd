...
counts_f <- '/home/egrassi/deseq_intro/data/counts_HX.tsv.gz'
gene_len_f <- '/home/egrassi/deseq_intro/data/gene_lengths.txt'
```
...
```{r, echo=FALSE}
knitr::include_graphics('./deseq2_shrunken_lfc.png', dpi=0.5)
