...
\begin{columns}
\column{.5\textwidth}
\begin{figure}\includegraphics[width=0.5\textwidth]{./img/dag_his2.pdf}\end{figure}
\column{.5\textwidth}
\begin{figure}\includegraphics[width=0.5\textwidth]{./img/dag_his3.pdf}\end{figure}
\end{columns}
\end{frame}
